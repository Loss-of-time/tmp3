...
- [x] v7 信号调仓：`etf_rot_signal.py` 每日检视+信号过滤，修复 v5 相位锚定伪 alpha

## v7 信号调仓 (`etf_rot_signal.py`)

- **背景**：v5 用 `i % REBAL == 0` 相对起跑日锚定调仓，穷举 40 个相位锚点年化分布中位 6.7% [2.4%, 26.7%]，宣称的 26.6% 恰是最优解 → 相位伪 alpha
...
- **结果（2020-2026, 底仓45%+cd=20）**：年化 24.7%, 夏普 0.98, 回撤 30.5%, 买入 8 次切换 1 次，每年跑赢基准（2021 +31.7%/-5.2%, 2022 +0.5%/-21.6%, 2023 +14.9%, 2024 +26.0%, 2025 +39.6%, 2026 +10.3%）
...
- 待办：MOM_GAP=1.0 是否可理解为"动量差>100%才切"需在 paper_trade 中落地
