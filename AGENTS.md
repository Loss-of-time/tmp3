...
- **官方口径**：v7 全窗回测 2015-01-01 起 **年化 22.9%/夏普0.96/回撤24.7%/总收益900.8%**（12 年 11 正 1 负）。模拟盘从 2026-08-03 开户重放，不受 BT_START 影响。
...
- **半止盈 TP_HALF=0.8**（2026-08-06 定稿）：轮动仓浮盈 80% 卖一半落袋，剩余跟 trail；落袋现金参与下次买入。实测（官方口径）年化 +1~+3.5pp、夏普 +0.1~0.2、回撤降 2~4pp 三者同改善，0.5~0.8 宽平台非过拟合。
